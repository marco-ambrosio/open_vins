...
public:
  ...
  void callback_stereo(const sensor_msgs::msg::Image::ConstSharedPtr msg0, const sensor_msgs::msg::Image::ConstSharedPtr msg1, int cam_id0,
                       int cam_id1);
  void callback_stereo(const sensor_msgs::msg::CompressedImage::ConstSharedPtr msg0,
...
protected:
  ...
  typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::CompressedImage, sensor_msgs::msg::CompressedImage>
      sync_pol_compressed;
  std::vector<std::shared_ptr<message_filters::Synchronizer<sync_pol>>> sync_cam;
  std::vector<std::shared_ptr<message_filters::Synchronizer<sync_pol_compressed>>> sync_cam_compressed;
  std::vector<std::shared_ptr<message_filters::Subscriber<sensor_msgs::msg::Image>>> sync_subs_cam;
  std::vector<std::shared_ptr<message_filters::Subscriber<sensor_msgs::msg::CompressedImage>>> sync_subs_cam_compressed;
